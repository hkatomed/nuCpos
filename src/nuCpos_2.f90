...
subroutine nuCpos_2(lfn,filename,freqL1,tranL1,TtranL2,TtranL3,TtranL4,TfreqN4,TtranN4,mlL,Pd,std,ind)
  ...
  deallocate(r,hatFN,hatFL,hatAL,hatBL); allocate(ppEndN(z+146),ppN(z),asc(74:z-73),Nst(0:z/147))
    ...
    do t=1+rts(q),z-rte(q)
      if(t<74.or.z-73<t) then
        ...
        write(1,'(i9,2x,f5.3,3x,f5.3,3x,i1,1x,f8.3)') base+st(q)-1+t,ppEndN(t+146),ppN(t),w(t),asc(t)
      end if
    end do
    close(1)
